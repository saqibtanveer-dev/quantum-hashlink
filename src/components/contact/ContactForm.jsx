...
const ContactInputBox = ({
  ...
  <div className="mb-6">
    <input
      ...
      value={value}
      onChange={onChange}
      className={`w-full rounded border ${error ? "border-red-700" : "border-stroke"} px-[14px] py-3 text-base text-body-color outline-none focus:border-primary`}
    />
