...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white pt-16 md:pt-20 lg:pt-24 px-4 lg:px-20">
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#b5246c" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#b5246c" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
