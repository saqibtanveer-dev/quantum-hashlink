const socialLinks = [
  {
    label: "Facebook",
    href: "https://facebook.com/quantumhashlink",
    icon: (
  ...
  {
    label: "Twitter/X",
    href: "https://x.com/quantumhashlink",
    icon: (
      <svg width="18" height="18" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@quantumhashlink",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/quantumhashlink",
    icon: (
  ...
  <div className="flex items-center">
    {socialLinks.map((link, idx) => (
      <a
        ...
        className={`${idx < socialLinks.length - 1 ? "mr-6" : ""} text-body-color duration-300 hover:text-primary`}
      >
        {link.icon}
      </a>
    ))}
