...
const courses = [
    ...
    },
  {
    ...
    description: 'Learn Python syntax, data structures, and fundamental programming concepts to build scripts and applications.',
  ...
  },
  {
    ...
    description: 'Master decorators, generators, context managers, and asynchronous programming in Python.',
  ...
  },
  {
    ...
    description: 'Understand core JavaScript concepts including ES6+, DOM manipulation, and event handling.',
  ...
  },
  {
    ...
    description: 'Explore advanced patterns such as closures, prototypes, async/await, and design patterns in JS.',
  ...
  },
  {
    ...
    description: 'Combine React frontend with Django REST framework to create robust web applications.',
  ...
  },
  {
    ...
    description: 'Learn server-side rendering, dynamic routing, and API routes with Next.js.',
  ...
  },
  {
    ...
    description: 'Introduction to machine learning algorithms, data preprocessing, and model evaluation using scikit-learn.',
  ...
  },
  {
    ...
    description: 'Create cross-platform mobile applications using React Native and deploy them to Android devices.',
    instructor: 'Linda Wu',
    price: '$79.99',
    prerequisites: 'JavaScript Fundamentals',
    duration: '3-6 Months'
  },
  {
    ...
    description: 'Implement CI/CD pipelines, containerization with Docker, and infrastructure as code using Terraform.',
...
export default function CourseEnrollment() {
  ...
  const [formData, setFormData] = useState({
    name: '', contact: '', dob: '', address: '', education: '', courseType: 'ONLINE'
  });
  ...
  const handleEnroll = (e) => {
    e.preventDefault();
    alert(`Enrolled ${formData.name} in ${selectedCourse.title}`);
          ...
          <div className="w-full lg:w-[70%] px-4 mb-8 lg:mb-0">
            <form onSubmit={handleEnroll} className="bg-white rounded-2xl shadow-lg p-6">
              <div className="grid gap-6 mb-6 md:grid-cols-2">
                {/* Course Select */}
                <div>
                  <label htmlFor="course-select" className="block mb-2 text-sm font-medium text-gray-900">Course</label>
                  <select
                    id="course-select"
                ...
                {/* Contact Number */}
                <div>
                  <label htmlFor="contact" className="block mb-2 text-sm font-medium text-gray-900">Contact Number</label>
                  <input
                    type="tel"
                    id="contact"
                    name="contact"
                ...
                {/* Course Type */}
                <div>
                  <label className="block mb-2 text-sm font-medium text-gray-900">Course Type</label>
                ...
                {/* Education */}
                <div>
                  <label htmlFor="education" className="block mb-2 text-sm font-medium text-gray-900">Education</label>
                  <input
                    type="text"
                    id="education"
                    name="education"
              ...
              >
                <FaUser className="mr-2" /> Enroll Now
              </button>
            </form>
          </div>
          ...
          <div className="w-full lg:w-[30%] px-4">
            <div className="bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-lg p-8 flex flex-col items-center text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-gray-100 overflow-hidden relative group">
                ...
                <ul className="text-gray-700 mb-6 space-y-3 w-full text-left">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="font-semibold text-sm text-pink-600">{selectedCourse.price}</span>
                    </li>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 7v5l3 1" />
                    </svg>
